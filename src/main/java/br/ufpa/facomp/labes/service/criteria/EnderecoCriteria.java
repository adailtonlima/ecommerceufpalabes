...
/**
 * Criteria class for the {@link br.ufpa.facomp.labes.domain.Endereco} entity. This class is used
 * in {@link br.ufpa.facomp.labes.web.rest.EnderecoResource} to receive all the possible filtering options from
...
public class EnderecoCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, nome, cep, logradouro, bairro, numero, cidade, complemento, usuarioId, distinct);
    }
