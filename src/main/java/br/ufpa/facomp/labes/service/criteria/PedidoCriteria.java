...
/**
 * Criteria class for the {@link br.ufpa.facomp.labes.domain.Pedido} entity. This class is used
 * in {@link br.ufpa.facomp.labes.web.rest.PedidoResource} to receive all the possible filtering options from
...
public class PedidoCriteria implements Serializable, Criteria {
    ...
    public PedidoCriteria(PedidoCriteria other) {
        ...
        this.produtosId = other.produtosId == null ? null : other.produtosId.copy();
    ...
    public LongFilter getProdutosId() {
        return produtosId;
    }

    public LongFilter produtosId() {
        if (produtosId == null) {
            produtosId = new LongFilter();
        }
        return produtosId;
    }

    public void setProdutosId(LongFilter produtosId) {
    ...
    public boolean equals(Object o) {
        ...
        return (
            ...
            Objects.equals(produtosId, that.produtosId) &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, criado, status, precoTotal, codigoPagamento, produtosId, usuarioId, enderecoId, distinct);
    }
    ...
    public String toString() {
        return "PedidoCriteria{" +
            ...
            (produtosId != null ? "produtosId=" + produtosId + ", " : "") +
