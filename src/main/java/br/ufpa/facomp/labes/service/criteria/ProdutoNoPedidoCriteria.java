...
/**
 * Criteria class for the {@link br.ufpa.facomp.labes.domain.ProdutoNoPedido} entity. This class is used
 * in {@link br.ufpa.facomp.labes.web.rest.ProdutoNoPedidoResource} to receive all the possible filtering options from
...
public class ProdutoNoPedidoCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, quantidade, preco, criado, produtoId, pedidoId, distinct);
    }
