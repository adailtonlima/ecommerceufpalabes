...
/**
 * Criteria class for the {@link br.ufpa.facomp.labes.domain.Produto} entity. This class is used
 * in {@link br.ufpa.facomp.labes.web.rest.ProdutoResource} to receive all the possible filtering options from
...
public class ProdutoCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, nome, fotoUrl, sku, ean, criado, preco, precoPromocional, totalEstoque, distinct);
    }
