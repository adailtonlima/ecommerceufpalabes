package br.ufpa.facomp.labes.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, br.ufpa.facomp.labes.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, br.ufpa.facomp.labes.repository.UserRepository.USERS_BY_EMAIL_CACHE);
