...
import br.ufpa.facomp.labes.repository.ProdutoNoPedidoRepository;
import br.ufpa.facomp.labes.service.ProdutoNoPedidoQueryService;
import br.ufpa.facomp.labes.service.ProdutoNoPedidoService;
import br.ufpa.facomp.labes.service.criteria.ProdutoNoPedidoCriteria;
...
/**
 * REST controller for managing {@link br.ufpa.facomp.labes.domain.ProdutoNoPedido}.
 */
@RestController
@RequestMapping("/api")
public class ProdutoNoPedidoResource {
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/produto-no-pedidos/{id}", consumes = { "application/json", "application/merge-patch+json" })
