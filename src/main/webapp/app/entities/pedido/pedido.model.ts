...
import { IProdutoNoPedido } from 'app/entities/produto-no-pedido/produto-no-pedido.model';
...
export interface IPedido {
  ...
  produtos?: IProdutoNoPedido[] | null;
...
export class Pedido implements IPedido {
  constructor(
    ...
    public produtos?: IProdutoNoPedido[] | null,
